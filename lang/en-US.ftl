...
config-rpcs3-savedata-path = RPCS3 custom savedata path (auto-searches for PS3 game codes)

config-enable-emulated-game-automation = Enable automatic Ludusavi custom entries for emulated games
config-emulated-game-title-format = Emulated game title format (supports <name>, <platform>, <emulator>)
...
## Emulated games
button-load-default-mappings = Load default emulator presets
button-clear-all-mappings = Clear all mappings
